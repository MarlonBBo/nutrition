import { Text, View, StyleSheet, Pressable, ScrollView, Share } from 'react-native';
...
export default function Nutrition() {
  ...
  const user = useDataStore(state => state.data)
  ...
  const {data, isFetching, error} = useQuery({
    ...
    queryFn: async () => {
      try{
        ...
        if(!user){
          throw new Error('Falha no carregamento da nutrição')
        } 
